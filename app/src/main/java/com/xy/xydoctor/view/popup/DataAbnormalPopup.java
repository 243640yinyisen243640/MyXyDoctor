...
public class DataAbnormalPopup extends BasePopupWindow {
    ...
    public DataAbnormalPopup(Context context, BaseCallBack callBack) {
        ...
        List<DataAbnormalInfo> abnormalInfos = new ArrayList<>();
        DataAbnormalInfo abnormalInfo1 = new DataAbnormalInfo(context.getString(R.string.data_abnormal_up));
        abnormalInfos.add(abnormalInfo1);
        DataAbnormalInfo abnormalInfo2 = new DataAbnormalInfo(context.getString(R.string.data_abnormal_low));
        abnormalInfos.add(abnormalInfo2);

        DataAbnormalInfo abnormalInfo3 = new DataAbnormalInfo(context.getString(R.string.data_abnormal_normal));
        abnormalInfos.add(abnormalInfo3);

        DataAbnormalInfo abnormalInfo4 = new DataAbnormalInfo(context.getString(R.string.data_abnormal_not));
