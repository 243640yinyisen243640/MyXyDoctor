 ...
 */
public class FollowUpVisitBloodSugarAdd2Adapter extends CommonAdapter<FollowUpVisitBloodSugarAddBean> {
    private AdapterClickSearchImp listener;
    private String status;
    public FollowUpVisitBloodSugarAdd2Adapter(Context context, int layoutId, List<FollowUpVisitBloodSugarAddBean> datas, AdapterClickSearchImp listener,
                                              String status) {
