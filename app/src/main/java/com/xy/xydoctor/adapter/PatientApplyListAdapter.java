...
public class PatientApplyListAdapter extends XyBaseAdapter<PatientApplyBean> {
    private int pos;
    private List<PatientApplyBean> list;

    public PatientApplyListAdapter(Context mContext, List<PatientApplyBean> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PatientApplyBean info = getList().get(position);
