...
public class FollowUpVisitLvAdapterThree extends BaseAdapter {
    ...
    public FollowUpVisitLvAdapterThree(Context context, List list, List<List<String>> medicineList, AdapterClickImp listener, String status) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if ("5".equals(status)) {
            ...
            viewHolder.etDosage.setEnabled(false);
