...
public class CommunityBuildingUnitChildListAdapter extends CommonAdapter<FollowUpAgentListBean> {

    private String type;
    private IAdapterViewClickListener clickListener;
    private int parentPosi;

    public CommunityBuildingUnitChildListAdapter(Context context, int layoutId, List<FollowUpAgentListBean> datas, String type, int parentPosi, IAdapterViewClickListener clickListener) {
