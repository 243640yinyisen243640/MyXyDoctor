 ...
 */
public class CommunityUserMedicineForSomeOneListAdapter extends RecyclerView.Adapter<CommunityUserMedicineForSomeOneListAdapter.ViewHolder> {
    ...
    public CommunityUserMedicineForSomeOneListAdapter(Context context, List<FollowUpAgentListBean> list, String type, IAdapterViewClickListener clickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = View.inflate(context, R.layout.item_user_medicine_child_list, null);
        //返回MyViewHolder的对象
