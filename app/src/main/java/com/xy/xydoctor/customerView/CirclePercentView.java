...
public class CirclePercentView extends View {
    ...
    public CirclePercentView(Context context, @Nullable AttributeSet attrs) {
        ...
        bgColor = typedArray.getColor(R.styleable.CirclePercentView_circleBgColor, getResources().getColor(R.color.gray_light));
        progressColor = typedArray.getColor(R.styleable.CirclePercentView_circleProgressColor, getResources().getColor(R.color.main_red));
        ...
        startColor = typedArray.getColor(R.styleable.CirclePercentView_circleStartColor, getResources().getColor(R.color.base_black));
